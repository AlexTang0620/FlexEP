<%@ Page Title="View Inspection" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="viewInspection.aspx.cs" Inherits="FLEX_INTI.Inspection.viewInspection" %>
...
<script src="~/Scripts/jquery-1.10.2.min.js"></script>
    ...
    <h1><%: Title %></h1>
    <p class="lead jumbotron">View the inspection of selected process.</p>
